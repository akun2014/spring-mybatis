...
public final class TypeHandlerRegistry {
    ...
    private static final Map<JdbcType, TypeHandler<?>> jdbcTypeHandlerMap = new EnumMap<>(JdbcType.class);
    private static final Map<Type, Map<JdbcType, TypeHandler<?>>> typeHandlerMap = new ConcurrentHashMap<>();
    private static final TypeHandler<Object> unknownTypeHandler = new UnknownTypeHandler();
    private static final Map<Class<?>, TypeHandler<?>> allTypeHandlersMap = new HashMap<>();
     ...
     * @since 3.4.5
     */
    public static void setDefaultEnumTypeHandler(Class<? extends TypeHandler> typeHandler) {
        TypeHandlerRegistry.defaultEnumTypeHandler = typeHandler;
    }
    ...
    private static Map<JdbcType, TypeHandler<?>> getJdbcHandlerMap(Type type) {
    ...
    private static Map<JdbcType, TypeHandler<?>> getJdbcHandlerMapForEnumInterfaces(Class<?> clazz, Class<?> enumClazz) {
    ...
    private static Map<JdbcType, TypeHandler<?>> getJdbcHandlerMapForSuperclass(Class<?> clazz) {
    ...
    @SuppressWarnings("unchecked")
    public static <T> void register(TypeHandler<T> typeHandler) {
    ...
    public static void register(Class<?> typeHandlerClass) {
        boolean mappedTypeFound = false;
